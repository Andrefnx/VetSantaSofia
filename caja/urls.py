...
urlpatterns = [
    ...
    path('abrir/', views_cobros.abrir_caja, name='abrir_caja'),  # Abrir sesión de caja
    path('cerrar/<int:sesion_id>/', views_cobros.cerrar_caja, name='cerrar_caja'),  # Cerrar sesión de caja
    ...
    path('api/sesion-activa/', views_cobros.api_sesion_activa, name='api_sesion_activa'),  # API para consultar sesión de caja activa

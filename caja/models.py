...
class Caja(models.Model):
    ...
    consulta = models.ForeignKey('gestion.Consulta', on_delete=models.SET_NULL, null=True, blank=True)
    hospitalizacion = models.ForeignKey('hospital.Hospitalizacion', on_delete=models.SET_NULL, null=True, blank=True)
